...
public class Heap <E> extends AbstractQueue<E> {
  ...
  */
  ...
  public boolean remove (Object o) {
    // EXERCISE
    if (theElements.isEmpty()) // change this to false
      return false;
    ...
    ///
    theElements.set(index, theElements.remove(size() - 1));
